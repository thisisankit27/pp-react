    ...
    return (
        ...
        <div className='text-center'>
            ...
            <p style={{ margin: "3% 13%" }}>
                ...
                <p>The Act also specifies a comprehensive list of 21 disabilities, which are included under the ambit of the Act and are broadly classified into 6 major categories <a href="https://legislative.gov.in/sites/default/files/A2016-49_1.pdf" target="_blank" rel="noreferrer nofollow">Follow</a></p>
            </p>
        </div >
    );
}
